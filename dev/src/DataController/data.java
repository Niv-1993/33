...
public class data {
    ...
    private void loadData(){
        try {
            ...
            supplierController.addItem(0 , "chicken" , 19.99, 1, LocalDate.now());
            supplierController.addItem(0 , "minced meat" ,  39.99, 2, LocalDate.now());
            supplierController.addItem(0 , "stake" , 70.5, 3, LocalDate.now());
            supplierController.addItem(1 ,"yogurt" ,  9.99, 4, LocalDate.now());
            supplierController.addItem(1 , "cheese cake",  35.2, 5, LocalDate.now());
            supplierController.addItem(1 , "gum"  ,1.99, 6, LocalDate.now());
            supplierController.addItem(1 , "lollipop" ,  0.5, 7, LocalDate.now());
            supplierController.addItem(2 ,  "windshield wiper",  15.99, 8, LocalDate.now());
            supplierController.addItem(2 , "broom", 19.99, 9, LocalDate.now());
            supplierController.addItem(3 , "soda" , 10.99, 10, LocalDate.now());
            supplierController.addItem(3 , "sprite ",  10.99, 11, LocalDate.now());
            supplierController.addItem(3 , "fanta" ,10.99, 12, LocalDate.now());
            supplierController.addItem(3 , "grape juice" , 10.99,13, LocalDate.now());
            supplierController.addItem(3 ,"orange juice" ,  10.99,14, LocalDate.now());
            supplierController.addItem(3 , "water", 5.99,15, LocalDate.now());
            supplierController.addItem(4 ,  "apple", 1.99,16, LocalDate.now());
            supplierController.addItem(4 , "orange",1.99,17, LocalDate.now());
            supplierController.addItem(4 , "tomato" ,0.99,18, LocalDate.now());
            supplierController.addItem(4 ,  "onion" ,1.5,19, LocalDate.now());
            for(int i = 0 ; i < 19 ; i++  ){
